...
ggplot(q2_data, aes(x = User_Score, y = log(Global_Sales))) +
  ...
  labs(title = "User Score vs Global Sales", x = "User Score", y = "Log of Global Sales")
...
ggplot(q2_data, aes(x = Critic_Score, y = log(Global_Sales))) +
  geom_point() +
  geom_smooth(method = "lm", col = "#de7e5d") +
  labs(title = "Critic Score vs Global Sales", x = "Critic Score", y = "Log of Global Sales")
...
q2_data %>% summarise(avgCS = mean(Critic_Score), sdCs = sd(Critic_Score), avgUS = mean(User_Score), sdUs = sd(User_Score))
